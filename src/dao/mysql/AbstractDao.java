/*
 * Абстрактный класс. Dao для таблиц clients, sales и tours_list отличаются запросами и переданными/полученными
 * сущностями.Реализована общая схема взаимодействия с таблицами. 
 * В наследниках MySql(Tour/Client/Sale)Dao подставляются необходимые sql-запросы
 * и парсятся полученные объекты. Наверное, самое лучшее, что получилось в этой работе.
 */
